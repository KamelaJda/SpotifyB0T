...
public class EmbedPaginator {
  ...
  public static EmbedPaginator create(
  ...
  public static EmbedPaginator create(
      List<EmbedBuilder> pages, User user, EventWaiter eventWaiter, InteractionHook interaction) {
    return new EmbedPaginator(pages, user, eventWaiter, interaction, 60);
  }

  private EmbedPaginator(
      List<EmbedBuilder> pages,
      User user,
      EventWaiter eventWaiter,
      InteractionHook interaction,
  ...
  public static ActionRow getActionRow(int page, List<?> pages) {
    ...
    buttons.add(
        RIGHT_BUTTON
            .withLabel(pages.size() == page ? "-" : page + 1 + "")
            .withDisabled(pages.size() == page));
